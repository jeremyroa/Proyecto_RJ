...
public:
    ...
    void setupUi(QWidget *register_client)
    {
        ...
        register_client->resize(240, 467);
        widget = new QWidget(register_client);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 10, 211, 442));
        ...
        lineEdit_correo = new QLineEdit(widget);
        ...
        lineEdit_estado = new QLineEdit(widget);
        ...
        comboBox_sexo = new QComboBox(widget);
    ...
    void retranslateUi(QWidget *register_client)
    {
        ...
        label_12->setText(QApplication::translate("register_client", "TextLabel", 0));
